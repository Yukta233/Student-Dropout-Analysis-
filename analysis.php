...
$states = loadRealData('C:/xampp/htdocs/php_c/Student_Dropout_Analysis/DOR.csv');
if (!file_exists('C:/xampp/htdocs/php_c/Student_Dropout_Analysis/DOR.csv')) {
...
$schoolTypeData = loadSchoolTypeData('C:\xampp\htdocs\php_c\Student_Dropout_Analysis\dataset.csv');
if (!file_exists('C:\xampp\htdocs\php_c\Student_Dropout_Analysis\dataset.csv')) {
    die('CSV file not found.');
}
                                    ...
                                    <div class="mt-6 space-y-4">
                                        <?php foreach ($data['causes'] as $cause): ?>
                                            <div class="p-4 bg-gray-50 rounded-lg border-l-4 border-accent">
                                                ...
                                                <p class="text-gray-700">Description of cause.</p>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                                    ...
                                    <div class="mt-6 space-y-4">
                                        <?php foreach ($data['strategies'] as $strategy): ?>
                                            <div class="p-4 bg-gray-50 rounded-lg">
                                                ...
                                                <p class="text-gray-700">Description of strategy.</p>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
